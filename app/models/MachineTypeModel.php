...
class MachineTypeModel extends MY_Model {

	// 表名
	public static $table_name = 'machine_type';

	// 包含字段
	public static $columns = 'id,type_name,module_num,module_plate_num,module_plate_code_num,status,update_time,create_time';
