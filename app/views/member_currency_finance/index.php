          ...
          <form id="activeRetentionForm" class="" method="GET">
              ...
              <div class="col-lg-2">
                <div class="control-group">
                  <div class="controls">
                    <div class="input-prepend input-group">
                        <button id="search-submit" type="button" class="btn btn-success">查询</button>&nbsp;<a href="/MemberCurrencyFinance/index" class="btn btn-default">重置</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <p>银行入账金额(元)</p>
              <h3><?php echo round($order_count['order_sum']*0.994,2);?></h3>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <p>不含税总收入(元)</p>
              <h3><?php echo round($order_count['order_sum']/1.06,2);?></h3>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <p>总税额(元)</p>
              <h3><?php echo round($order_count['order_sum']/1.06*0.06,2);?></h3>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <p>手续费(元)</p>
              <h3><?php echo round($order_count['order_sum']*0.006,2);?></h3>
            </div>
          </div>
        </div>
              ...
              <table class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                          ...
                          <th style="line-height: 30px;text-align: center;">总订充值单(个)</th>
                          <th style="line-height: 30px;text-align: center;">充值总额(元)</th>
                          <th style="line-height: 30px;text-align: center;">银行入账金额(元)</th>
                          <th style="line-height: 30px;text-align: center;">不含税净充值总额(元)</th>
                        ...
                        <tr style="text-align: center;">
                          ...
                          <td><?php echo round($v['order_count']['order_sum']*0.994,2); ?></td>‬
                          <td><?php echo round($v['order_count']['order_sum']/1.06,2); ?></td>‬
                          <td>6%</td>
                          <td><?php echo round($v['order_count']['order_sum']/1.06*0.06,2); ?></td>
                          <td><?php echo round($v['order_count']['order_sum']*0.006,2); ?></td>
                          <td>
                            <div class="input-group input-group-sm" style="width: 50px;">
                              <div class="input-group-btn">
                                  <a class="btn" href="/MemberCurrencyFinance/outputOrderExcel?date=<?php echo $k?>&pay_type=<?php echo isset($pay_type)?$pay_type:'' ?>">导出</a>
                              </div>
                            </div>
                          </td>
                        </tr>
...
$(function(){     
    ...
    $('#search-submit').on("click",function(){
        $Form.attr("action","/MemberCurrencyFinance/index");
        $Form.submit();
    });

    $('#output').on("click",function(){
        $Form.attr("action","/MemberCurrencyFinance/outputExcel");
        $Form.submit();
    });
});    
</script>
