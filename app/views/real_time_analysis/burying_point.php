        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body table-responsive">
                    ...
                    <div class="btn-group">
                        <span class="btn btn-default chartbtn" data-viem='real_time'>实时访问</span>
                        <span class="btn btn-primary chartbtn" data-viem='burying_point'>埋点数据</span>
                    </div>
                    ...
                    <div class="col-xs-12" id="echarts-burying_point" style="margin-top:50px;height:500px;"></div>
                </div>
            </div>
        </div>
    </div>
...
function get_series(){
    ...
    var url = '<?php echo base_url('RealTimeAnalysis/index');?>'+'?viem=burying_point';
    $.ajax({
        type: 'GET',
        url: url,
        data: {
        ...
        success: function(data){
          if(data.code==200){
            ...
            var myChart = echarts.init(document.getElementById('echarts-burying_point'));
            // 指定图表的配置项和数据
            option = {
                tooltip: {
                    trigger: 'axis'
...
$('#download').on('click', function(){
	var time_type = $("#time_type").val();
	var reservation = $("#reservation").val();
    var to_url = '<?php echo base_url('RealTimeAnalysis/index');?>'+'?viem=burying_point&operate=download';
