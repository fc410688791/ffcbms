  ...
  <div class='modal-dialog' style="width:860px;">
    <div class='modal-content'>
      <div class='modal-header'>
        ...
        <h4 class='modal-title'>请选择更换的图标</h4>
      </div>
      <div class="modal-body">
        ...
        <section id="web-application">
          <div class="row fontawesome-icon-list">
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-automobile"></i> fa-automobile</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-bank"></i> fa-bank</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-bar-chart"></i> fa-bar-chart</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-bar-chart-o"></i> fa-bar-chart-o</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-battery-0"></i> fa-battery-0</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-battery-1"></i> fa-battery-1</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-battery-2"></i> fa-battery-2</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-battery-3"></i> fa-battery-3</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-battery-4"></i> fa-battery-4</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-cab"></i> fa-cab</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-close"></i> fa-close</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-dashboard"></i> fa-dashboard</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-edit"></i> fa-edit</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-feed"></i> fa-feed</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-file-movie-o"></i> fa-file-movie-o</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-file-pdf-o"></i> fa-file-pdf-o</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-file-photo-o"></i> fa-file-photo-o</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-file-picture-o"></i> fa-file-picture-o</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-file-powerpoint-o"></i> fa-file-powerpoint-o
            </div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-file-sound-o"></i> fa-file-sound-o</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-file-zip-o"></i> fa-file-zip-o</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-flash"></i> fa-flash</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-gear"></i> fa-gear</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-gears"></i> fa-gears</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-group"></i> fa-group</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-hand-grab-o"></i> fa-hand-grab-o</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-hand-stop-o"></i> fa-hand-stop-o</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-hotel"></i> fa-hotel</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-hourglass"></i> fa-hourglass</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-hourglass-1"></i> fa-hourglass-1</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-hourglass-2"></i> fa-hourglass-2</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-hourglass-3"></i> fa-hourglass-3</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-image"></i> fa-image</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-institution"></i> fa-institution</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-legal"></i> fa-legal</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-life-bouy"></i> fa-life-bouy</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-life-buoy"></i> fa-life-buoy</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-life-ring"></i> fa-life-ring</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-life-saver"></i> fa-life-saver</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-mail-forward"></i> fa-mail-forward</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-mail-reply"></i> fa-mail-reply</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-mail-reply-all"></i> fa-mail-reply-all</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-mobile-phone"></i> fa-mobile-phone</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-mortar-board"></i> fa-mortar-board</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-navicon"></i> fa-navicon</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-photo"></i> fa-photo</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-remove"></i> fa-remove</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-reorder"></i> fa-reorder</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-send"></i> fa-send</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-send-o"></i> fa-send-o</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-soccer-ball-o"></i> fa-soccer-ball-o</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-sort-down"></i> fa-sort-down</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-sort-up"></i> fa-sort-up</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-star-half-empty"></i> fa-star-half-empty</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-star-half-full"></i> fa-star-half-full</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-support"></i> fa-support</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-toggle-down"></i> fa-toggle-down</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-toggle-left"></i> fa-toggle-left</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-toggle-right"></i> fa-toggle-right</div>
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-toggle-up"></i> fa-toggle-up</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-tv"></i> fa-tv</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-unsorted"></i> fa-unsorted</div>
            ...
            <div class="col-md-3 col-sm-4 icon"><i class="fa fa-fw fa-warning"></i> fa-warning</div>
...
$('.icon').click(function(){
    var obj=$(this);
    var new_icon = "fa fa-fw "+obj.text();
    $('#icon_preview').removeClass().addClass(new_icon);
    $('#module_icon').val(obj.text());
