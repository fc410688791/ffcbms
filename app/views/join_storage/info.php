                    ...
                    <table id="example1" class="table table-bordered table-striped" style="text-align: center;">
                        ...
                        <?php foreach ($list as $key=>$info): ?>
                            <tr>
                                ...
                                <td><img class="file_image" alt="" src="<?php echo $join_info['thumbnail_file']; ?>"></td>
                                <td><a href="<?php echo base_url('AgentProduct/index').'?id='.$join_info['agent_product_id']; ?>"><?php echo $join_info['name']; ?></a></td>
                                <td><?php echo $join_info['agent_product_type_name']; ?></td>
                                <td><?php echo $join_info['type_name']; ?></td>
                                <td><?php echo $info['batch_storage_num']; ?></td>
                                <td><?php echo $join_info['storage_time']; ?></td>
                                <td><?php echo $join_info['storage_user']; ?></td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
                    </table>
