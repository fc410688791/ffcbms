        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <h3>充电分析</h3>
                    <div class="btn-group">
                        <span class="btn btn-primary chartbtn" data-viem='product'>充电分布</span>
                        <span class="btn btn-default chartbtn" data-viem='product_time'>充电数据</span>
                    </div>
...
function get_series(){
    ...
    var url = '<?php echo base_url('OrderStatistics/index');?>'+'?viem=product';
    $.ajax({
        type: 'GET',
        url: url,
        data: {
...
$('#download').on('click', function(){
	var time_type = $("#time_type").val();
	var reservation = $("#reservation").val();
    var to_url = '<?php echo base_url('OrderStatistics/index');?>'+'?viem=product&operate=download';
