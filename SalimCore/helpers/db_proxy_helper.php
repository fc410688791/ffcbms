<?php
/**
 * [load_db_proxy_setting 根据当前加载的group以及查询类型获取是否使用主从, 使用主从则返回一个db配置数组]
 *
 * @Author leeprince:2019-03-20T18:35:00+0800
 * @param  string                             $group_name     [description]
 * @param  boolean                            $is_write_query [description]
 * @param  boolean                            $force_master   [description]
